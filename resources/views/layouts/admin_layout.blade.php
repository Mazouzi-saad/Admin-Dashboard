...
<meta property="og:url" content="http://demos.creative-tim.com/material-dashboard/pages/{{url('/')}}" />
...
<link id="pagestyle" href="{{url('/')}}/assets/css/material-dashboard.min.css?v=3.0.4" rel="stylesheet" />
