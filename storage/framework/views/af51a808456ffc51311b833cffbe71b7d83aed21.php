...
<meta property="og:url" content="http://demos.creative-tim.com/material-dashboard/pages/<?php echo e(url('/')); ?>" />
...
<link id="pagestyle" href="<?php echo e(url('/')); ?>/assets/css/material-dashboard.min.css?v=3.0.4" rel="stylesheet" />
...
<img src="<?php echo e(url('/')); ?>/assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
...
<div class="my-auto">
<img src="<?php echo e(url('/')); ?>/assets/img/team-2.jpg" class="avatar avatar-sm  me-3 ">
</div>
...
<div class="d-flex py-1">
<div class="my-auto">
<img src="<?php echo e(url('/')); ?>/assets/img/small-logos/logo-spotify.svg" class="avatar avatar-sm bg-gradient-dark  me-3 ">
</div>
<div class="d-flex flex-column justify-content-center">
<h6 class="text-sm font-weight-normal mb-1">
...
</html><?php /**PATH C:\xampp\htdocs\dashboard\resources\views/layouts/admin_layout.blade.php ENDPATH**/ ?>